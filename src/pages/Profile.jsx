    ...
    >
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          {/* Profile Header */}
          <div
            className={`rounded-2xl p-8 mb-6 transition-colors duration-300 shadow-lg ${
            ...
            <div className="text-center mb-8">
              <div className="relative inline-block">
                <img
                  src={
                    user?.photoURL ||
                    `https://via.placeholder.com/120x120/3B82F6/FFFFFF?text=${
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl transition-all duration-300 border ${
                        isDark
                  ...
                  >
                    <p
                      className={`text-sm ${
                        isDark ? "text-yellow-300" : "text-[#92400E]"
                      }`}
                    >
                      <strong>Note:</strong> Email address cannot be changed.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
              className={`p-6 rounded-xl shadow-md text-center transition-colors duration-300 ${
                isDark ? "bg-gray-800" : "bg-white"
              }`}
            >
