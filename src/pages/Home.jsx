            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {(featuredCourses.length > 0
                ...
                <motion.div
                  ...
                  } rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2 border`}
                  data-aos="fade-up"
                ...
                >
                  ...
                  <div className="relative overflow-hidden">
                    <img
                      src={
                        course.image ||
                        "https://via.placeholder.com/400x250/3B82F6/FFFFFF?text=Course+Image"
                      }
                      alt={course.title}
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 text-sm mb-4 line-clamp-3 leading-relaxed">
                      {course.description ||
                        "Enhance your skills with this comprehensive course designed for learners of all levels."}
                    </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            >
              ...
              <p className="text-gray-600">
                Quality education at competitive prices with payment plans
              </p>
            </motion.div>
          </div>
        </div>
            ...
            {instructors.map((instructor, index) => (
              ...
              >
                ...
                <div className="card-body items-center text-center pb-10">
                  <h3 className="card-title font-bold text-[#1F2937]">
                    {instructor.name}
                  </h3>
